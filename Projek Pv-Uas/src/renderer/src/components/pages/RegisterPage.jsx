...
// import { useNavigate, Link } from 'react-router-dom';
// import { 
//   Card, CardContent, TextField, Button, Typography, Alert, Box,
//   FormControl, InputLabel, Select, MenuItem 
// } from '@mui/material';

// export default function RegisterPage() {
//   // Tambahkan state untuk 'role', defaultnya 'user'
...
//     e.preventDefault();
//     try {
//       // Kirim role juga ke fungsi register
...
//               >
//                 <MenuItem value="user">Mahasiswa / Peminjam</MenuItem>
//                 <MenuItem value="admin">Administrator / Staff</MenuItem>
//               </Select>
//             </FormControl>

//             <Button fullWidth variant="contained" color="secondary" type="submit" sx={{ mt: 2 }}>
//               Daftar Sekarang
//             </Button>
//           </form>
